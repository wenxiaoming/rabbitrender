...
////#define DUMP_TRIANBLE
#ifdef DUMP_TRIANBLE
		if (1)
		{
			printf("triangle \r\n");
			printf("p0->window.x:%d(%f) p0->window.y:%d(%f) p0->window.z:%d(%f) \r\n", p0->window.x, (float)p0->window.x/float(TRI_ONE), p0->window.y,  (float)p0->window.y/float(TRI_ONE), p0->window.z, (float)p0->window.z/float(TRI_ONE));
			printf("p1->window.x:%d(%f) p1->window.y:%d(%f) p1->window.z:%d(%f) \r\n", p1->window.x, (float)p1->window.x/float(TRI_ONE), p1->window.y,  (float)p1->window.y/float(TRI_ONE), p1->window.z, (float)p1->window.z/float(TRI_ONE));
			printf("p2->window.x:%d(%f) p2->window.y:%d(%f) p2->window.z:%d(%f) \r\n", p2->window.x, (float)p2->window.x/float(TRI_ONE), p2->window.y,  (float)p2->window.y/float(TRI_ONE), p2->window.z, (float)p2->window.z/float(TRI_ONE));
		}
