...
#if OS_MACOSX
#include "platform/darwin/message_loop_darwin.h"
#elif OS_ANDROID
#include "platform/android/message_loop_android.h"
#elif OS_FUCHSIA
#include "platform/fuchsia/message_loop_fuchsia.h"
#elif OS_LINUX
#include "platform/linux/message_loop_linux.h"
#elif OS_WIN
